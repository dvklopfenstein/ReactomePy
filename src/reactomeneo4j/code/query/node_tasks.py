...
__copyright__ = "Copyright (C) 2010-2018, DV Klopfenstein, All rights reserved."
...
def get_id2upper(objs):
    ...
    id2upper = {}
    for obj in objs:
        _get_id2upper(id2upper, obj.dbid, obj)
    return id2upper
...
def get_id2lower(objs):
    ...
    id2lower = {}
    for obj in objs:
        _get_id2lower(id2lower, obj.dbid, obj)
    return id2lower
...
class CurNHigher(object):
    ...
    def _get_id2obj_high(self, id2obj_user, id_sources, fnc_fill):
        ...
        for idid_user in id_sources:
            ...
            id2obj_user[idobj_user.dbid] = idobj_user
            if idid_user != idobj_user.dbid:
    ...
    def fill_parentidid2obj_r0(self, id2obj, child_obj):
        ...
        for parent_obj in child_obj.parents:
            if parent_obj.dbid not in id2obj:
                id2obj[parent_obj.dbid] = parent_obj
    ...
    def fill_parentidid2obj_r1(self, id2obj_user, child_obj):
        ...
        for higher_obj in self._getobjs_higher(child_obj):
            if higher_obj.dbid not in id2obj_user:
                id2obj_user[higher_obj.dbid] = higher_obj
...
# Copyright (C) 2010-2018, DV Klopfenstein, All rights reserved.
